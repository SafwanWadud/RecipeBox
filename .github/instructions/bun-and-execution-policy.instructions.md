...
This project uses **Bun** as the package manager and runtime environment. The presence of [bun.lock](../../bun.lock) confirms this setup.
...
The project dependencies are managed through [package.json](../../package.json) and locked in [bun.lock](../../bun.lock).
