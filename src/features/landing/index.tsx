...
export const Landing = () => {
    return (
        <div className='min-h-screen flex flex-col bg-background'>
            {/* Hero Section */}
            <section className='relative overflow-hidden bg-linear-to-br from-primary via-primary/90 to-accent'>
                {/* Decorative elements */}
                <div className='absolute inset-0 overflow-hidden pointer-events-none'>
                    <div className='absolute -top-40 -right-40 w-80 h-80 rounded-full bg-white/10' />
                    <div className='absolute top-1/2 -left-20 w-60 h-60 rounded-full bg-white/10' />
                ...
                <div className='relative z-10 flex flex-col items-center justify-center px-6 py-20 md:py-32 text-center'>
                    <h1 className='text-4xl md:text-6xl lg:text-7xl font-bold text-white max-w-4xl leading-tight'>
                        Your Recipes, <span className='text-accent'>Beautifully Organized</span>
                    </h1>
                    <p className='mt-6 text-lg md:text-xl text-white/90 max-w-2xl'>
                        Create, organize, and share your favorite recipes. Build your personal cookbook and never lose a cherished family recipe again.
                    </p>
            ...
            <section className='py-20 md:py-32 px-6 md:px-12 lg:px-20'>
                <div className='max-w-6xl mx-auto'>
                    <div className='text-center mb-16'>
                        <h2 className='text-3xl md:text-4xl font-bold text-foreground'>Everything You Need to Cook Amazing Meals</h2>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
                        {features.map((feature) => (
                            <Card key={feature.title} className='border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 hover:-translate-y-1'>
            ...
            <section className='py-20 px-6 md:px-12 lg:px-20 bg-muted'>
                <div className='max-w-4xl mx-auto text-center'>
                    <h2 className='text-3xl md:text-4xl font-bold text-foreground'>Ready to Transform Your Cooking?</h2>
