            ...
            <section className="relative overflow-hidden bg-linear-to-br from-primary via-primary/90 to-accent">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center px-6 py-20 md:py-32 text-center">
                    ...
                    <p className="mt-6 text-lg md:text-xl text-white/90 max-w-2xl">
                        Create, organize, and share your favorite recipes. Build your personal cookbook and never lose a
                        cherished family recipe again.
                    </p>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {features.map((feature) => (
                            <Card
                                key={feature.title}
                                className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 hover:-translate-y-1">
