...
export const DeleteRecipeBookDialog = ({ recipeBookId, recipeBookName, open, setOpen }: DeleteRecipeBookDialogProps) => {
                ...
                <DialogHeader>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <DialogDescription>
                                Are you sure you want to delete {recipeBookName ? <strong>"{recipeBookName}"</strong> : 'this recipe book'}? This action cannot
                                be undone.
                            </DialogDescription>
                        </div>
                    </div>
