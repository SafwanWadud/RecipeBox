...
import { ArrowLeft, ChefHat, Clock, Flame, MoreHorizontal, Timer, Users, Utensils, Star, Pencil, Trash2 } from 'lucide-react';
                ...
                <div className='relative overflow-hidden rounded-3xl bg-linear-to-br from-primary/10 via-background to-secondary/20 border border-border/50 shadow-xl p-8 md:p-12'>
                    ...
                    <div className='relative z-10 max-w-3xl space-y-6'>
                        <div className='space-y-2'>
                            ...
                            <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground'>{recipe.name}</h1>
                        </div>
                        ...
                        <Card className='h-full border-border/60 bg-card/50 backdrop-blur-xs'>
                            ...
                            <CardContent className='pt-6'>
                                {recipe.ingredients ? (
                                    ...
                                    <p className='text-muted-foreground/50 italic text-center py-8'>No ingredients listed</p>
                                )}
                            </CardContent>
                        </Card>
                    </div>
                        ...
                        <Card className='h-full border-border/60 bg-card/50 backdrop-blur-xs'>
                            ...
                            <CardContent className='pt-6'>
                                {recipe.directions ? (
                                    ...
                                    <p className='text-muted-foreground/50 italic text-center py-12'>No directions listed</p>
                                )}
                            </CardContent>
                        </Card>
                    </div>
